...
export const FEINT_SECONDS = 0.25;
...
export const GUARD_BREAK_DAMAGE = 6;
export const GUARD_BREAK_STUN_SECONDS = 0.52;
export const GUARD_BREAK_GUARD_STUN_SECONDS = 0.82;
